...
import com.wynndie.sottreasury.sharedCore.domain.outcome.Error
import com.wynndie.sottreasury.sharedCore.domain.outcome.ValidationError
import com.wynndie.sottreasury.sharedCore.presentation.formatters.UiText
import com.wynndie.sottreasury.sharedCore.presentation.formatters.UiText.ResourceString
import com.wynndie.sottreasury.sharedResources.Res.string
import com.wynndie.sottreasury.sharedResources.error_above_maximum_length
import com.wynndie.sottreasury.sharedResources.error_above_maximum_value
import com.wynndie.sottreasury.sharedResources.error_bad_request
import com.wynndie.sottreasury.sharedResources.error_below_minimum_length
import com.wynndie.sottreasury.sharedResources.error_below_minimum_value
import com.wynndie.sottreasury.sharedResources.error_disk_full
import com.wynndie.sottreasury.sharedResources.error_empty_field
import com.wynndie.sottreasury.sharedResources.error_exact_length_required
import com.wynndie.sottreasury.sharedResources.error_exact_value_required
import com.wynndie.sottreasury.sharedResources.error_forbidden
import com.wynndie.sottreasury.sharedResources.error_internal_server_error
import com.wynndie.sottreasury.sharedResources.error_invalid_characters
import com.wynndie.sottreasury.sharedResources.error_invalid_format
import com.wynndie.sottreasury.sharedResources.error_no_internet
import com.wynndie.sottreasury.sharedResources.error_not_found
import com.wynndie.sottreasury.sharedResources.error_request_timeout
import com.wynndie.sottreasury.sharedResources.error_serialization
import com.wynndie.sottreasury.sharedResources.error_too_many_requests
import com.wynndie.sottreasury.sharedResources.error_unauthorized
import com.wynndie.sottreasury.sharedResources.error_unknown
