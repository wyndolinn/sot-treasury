package com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.dao

import androidx.room.Dao
import androidx.room.Query
import androidx.room.Transaction
import androidx.room.Upsert
import com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.entities.CategoryEntity
import com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.entities.EmissaryEntity
import com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.entities.FactionEntity
import com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.entities.SubcategoryEntity
import com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.entities.TreasureEntity
import com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.entities.TreasureValueEntity
import com.wynndie.sottreasurecalculator.sharedFeatures.calculator.data.local.entities.TreasureWithValues
